    ...
    <section class="content">
      ...
      <div class="box box-default">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <div class="input-group date">
                      ...
                      <input type="text" class="form-control pull-right" name="mulai_dari" id="mulai_dari"  value="{{$data->mulai_dari}}"  placeholder="yyyy-mm-dd">
                    </div>
        ...
        <div class="box-footer">
          <div class="btn-group">
            <button type="button" class="btn btn-danger" onclick="location.assign(`{{url('nonwarga')}}`)">Kembali</button>
