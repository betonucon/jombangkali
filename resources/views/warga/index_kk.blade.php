...
<script type="text/javascript">
        ...
        */
        ...
        function pilih_pernikahan(pernikahan){
          ...
          var aktif=$('#aktif').val();
          tables.ajax.url("{{ url('kk/getdata')}}?aktif="+aktif+"&pekerjaan="+pekerjaan+"&pernikahan="+pernikahan).load();
          ...
          <div class="row">
            <div class="col-md-3">
              ...
              <div class="form-group">
                  <label></label>
                  <div class="btn-group">
                    <button type="button" class="btn btn-sm btn-info" onclick="location.assign(`{{url('kk/cetak')}}`)"><i class="fa fa-print"></i> Cetak</button>
                  </div>
              </div>
            </div>
            <div class="col-md-2">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form  id="mydataimport" method="post" action="{{ url('kk/import') }}" enctype="multipart/form-data" >
                    @csrf 
                    <input type="submit">
                    <div class="form-group">
...
@push('ajax')
    <script>
      ...
      function tambah(id){
        location.assign("{{url('kk/create')}}?id="+id)
      }
             ...
             if (willDelete) {
                 $.ajax({
                   ...
                   success: function(msg){
                     ...
                     var table=$('#data-table-fixed-header').DataTable();
                          table.ajax.url("{{ url('kk/getdata')}}").load();
                   }
                 });
