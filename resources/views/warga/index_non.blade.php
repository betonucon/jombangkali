          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="form-group">
                  <label></label>
                  <div class="btn-group">
                    <button type="button" class="btn btn-primary" onclick="tambah(0)"><i class="fa fa-plus"></i> Tambah data</button>
                    <button type="button" class="btn btn-success" onclick="$('#modal-import').modal('show')"><i class="fa fa-save"></i> Import</button>
                  </div>
              </div>
            </div>
            <div class="col-md-2">
                ...
                <table id="data-table-fixed-header" class="cell-border">
                    <thead>
                        <tr>
                            ...
                            <th width="5%"></th>
                            <th width="13%">NIK</th>
                            <th width="13%">NO Kartu Keluarga</th>
                            <th>Nama </th>
                            <th width="20%">Tempat Tanggal Lahir</th>
                            <th width="9%">J.Kelamin</th>
                            <th width="9%">Umur</th>
